...
For more detail on any specific method, check out the API reference. For some more examples of Kyanite scripts doing things like complex, tensor, and surgical operations, check out the [Examples](https://app.gitbook.com/s/QKU1AcyqATLn4jzuN591/examples "mention").
